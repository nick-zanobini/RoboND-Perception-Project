...
def pcl_callback(pcl_msg):
    ...
    # ----------------------------------------
    pcl_unfiltered_pub.publish(pcl_to_ros(cloud))
    # ----------------------------------------
    ...
    # Much like the previous filters, we start by creating a filter object:
    objects_filter = objects_cloud.make_statistical_outlier_filter()
    ...
    # Finally call the filter function for magic
    objects_filtered = objects_filter.filter()

    # ----------------------------------------
    pcl_objects_filtered_pub.publish(pcl_to_ros(objects_filtered))
    # ----------------------------------------

    # TODO: Euclidean Clustering
    white_cloud = XYZRGB_to_XYZ(objects_filtered)
...
if __name__ == '__main__':
    ...
    pcl_objects_filtered_pub = rospy.Publisher("/pcl_objects_filtered", PointCloud2, queue_size=1)
    # ----------------------------------------
